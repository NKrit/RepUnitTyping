...
In the non-prediction mode, it can also predict the presence/insertion or absence/deletion of any genomic regions (not limited to VNTR loci) specified by nucleotide sequences (~50 bp) given in the multi-fasta format.  
