...
parser.add_option("-c","--cutoff",action="store",type="float",dest="cutoff",default=0.1,help="threshold for the presence of each sequence [Default: 0.1] times the average read depth calculated from Mtb genome size")
